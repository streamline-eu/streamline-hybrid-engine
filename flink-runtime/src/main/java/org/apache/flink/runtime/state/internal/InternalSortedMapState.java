...
/**
 * The peer to the {@link SortedMapState} in the internal state type hierarchy.
 *
 ...
 */
public interface InternalSortedMapState<N, UK, UV> extends InternalKvState<N>, SortedMapState<UK, UV> {}
