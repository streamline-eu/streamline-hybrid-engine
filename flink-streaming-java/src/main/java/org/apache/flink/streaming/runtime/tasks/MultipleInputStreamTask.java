...
public class MultipleInputStreamTask<IN, OUT> extends StreamTask<OUT, OneInputStreamOperator<IN, OUT>> {
	...
	private MultipleStreamInputProcessor inputProcessor;
	 ...
	 */
	@VisibleForTesting
	public MultipleInputStreamTask(
			Environment env,
	...
	protected void run() throws Exception {
		...
		final MultipleStreamInputProcessor inputProcessor = this.inputProcessor;
