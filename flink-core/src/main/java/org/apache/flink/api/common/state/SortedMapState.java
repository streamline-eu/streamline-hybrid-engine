...
/**
 * {@link State} interface for partitioned, sorted key-value state. The key-value pair can be
 ...
 */
@PublicEvolving
public interface SortedMapState<UK, UV> extends State {
	...
	/**
	 * Navigates over all the mappings in the state.
	 *
	 * @return An navigator over all the mappings in the state
	 *
	 * @throws Exception Thrown if the system cannot access the state.
	 */
	Navigator<UK, UV> navigator() throws Exception;
}
