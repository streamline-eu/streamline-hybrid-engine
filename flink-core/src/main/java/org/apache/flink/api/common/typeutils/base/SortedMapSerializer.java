...
/**
 * A serializer for {@link java.util.TreeMap}. The serializer relies on a key serializer and a value serializer
 ...
 */
@Internal
public final class SortedMapSerializer<K, V> extends TypeSerializer<SortedMap<K, V>> {
	 ...
	 */
	public SortedMapSerializer(TypeSerializer<K> keySerializer, TypeSerializer<V> valueSerializer) {
	...
	public TypeSerializer<SortedMap<K, V>> duplicate() {
		...
		return new SortedMapSerializer<>(duplicateKeySerializer, duplicateValueSerializer);
	}
	...
	public SortedMap<K, V> copy(SortedMap<K, V> from) {
		SortedMap<K, V> newMap = new TreeMap<>();
	...
	@Override
	public void serialize(SortedMap<K, V> map, DataOutputView target) throws IOException {
	...
	@Override
	public SortedMap<K, V> deserialize(DataInputView source) throws IOException {
	...
	@Override
	public SortedMap<K, V> deserialize(SortedMap<K, V> reuse, DataInputView source) throws IOException {
	...
	public boolean equals(Object obj) {
		return obj == this ||
				(obj != null && obj.getClass() == getClass() &&
						keySerializer.equals(((SortedMapSerializer<?, ?>) obj).getKeySerializer()) &&
						valueSerializer.equals(((SortedMapSerializer<?, ?>) obj).getValueSerializer()));
	}
	...
	@Override
	public SortedMapSerializerConfigSnapshot snapshotConfiguration() {
