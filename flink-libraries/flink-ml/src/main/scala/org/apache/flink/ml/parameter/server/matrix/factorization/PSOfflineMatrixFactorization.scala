...
import org.apache.flink.ml.parameter.server.matrix.factorization.factors.RangedRandomFactorInitializerDescriptor
...
import org.apache.flink.ml.parameter.server.matrix.factorization.workers.PSOfflineMatrixFactorizationWorker
...
object PSOfflineMatrixFactorization {
  ...
  def psOfflineMF(src: DataStream[Rating],
    ...
    import org.apache.flink.ml.parameter.server.utils.FlinkEOF._
