...
import org.apache.flink.ml.parameter.server.passive.aggressive.algorithm.PassiveAggressiveBinaryAlgorithm
import org.apache.flink.ml.parameter.server.test.utils.FlinkTestUtils.{SuccessException, executeWithSuccessCheck}
  ...
  "Passive Aggressive with PS" should "give reasonable error on test data" in {
    ...
    PassiveAggressiveParameterServer.transformBinary(None)(
      ...
      override def close(): Unit = {
        import org.apache.flink.ml.parameter.server.test.utils.PassiveAggressiveBinaryModelEvaluation
